...
be created in an "ExportedImages" directory, out of the directory that the app
is in.
...
Add option for transparent text
Add option to select which corner to add text
Scale text to size of image